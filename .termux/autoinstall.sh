...
echo -e "${GREEN}Time to install Nala Package Manager, Z Shell, Termux Clipboard, Git, GitHub CLI, Neovim, NodeJS, Python-pip, Ruby, LuaRocks, LuaJIT, wget, logo-ls, Timewarrior, Taskwarrior, and htop!${ENDCOLOR}"
sleep 5
...
nala install zsh termux-api gh neovim nodejs python-pip ruby luarocks luajit wget logo-ls timewarrior taskwarrior htop -y || error_exit "${RED}Failed to install packages.${ENDCOLOR}"
