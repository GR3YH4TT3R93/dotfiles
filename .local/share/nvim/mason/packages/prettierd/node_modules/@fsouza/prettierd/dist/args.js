...
const commands = [
    ...
    },
    {
        ...
        description: "Print debugging information (information about the version of prettier being used for the provided path, for example `prettierd --debug-info src/my-file.js`).",
    },
    {
        command: "start\t\t",
